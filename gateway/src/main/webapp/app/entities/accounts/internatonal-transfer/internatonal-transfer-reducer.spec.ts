...
import reducer, {
  ...
  reset,
  updateEntity,
} from './internatonal-transfer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTERNATONALTRANSFER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INTERNATONALTRANSFER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INTERNATONALTRANSFER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INTERNATONALTRANSFER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INTERNATONALTRANSFER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INTERNATONALTRANSFER actions', async () => {
      const arg = 42666;
