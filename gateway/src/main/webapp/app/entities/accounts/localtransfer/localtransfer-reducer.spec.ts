...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOCALTRANSFER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOCALTRANSFER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOCALTRANSFER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LOCALTRANSFER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LOCALTRANSFER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LOCALTRANSFER actions', async () => {
      const arg = 42666;
