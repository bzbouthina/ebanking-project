...
export const QRPaymentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.paymentQRPayment.delete.question">
        <Translate contentKey="gatewayApp.paymentQRPayment.delete.question" interpolate={{ id: qRPaymentEntity.id }}>
